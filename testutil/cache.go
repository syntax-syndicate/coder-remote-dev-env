...
func PersistentCacheDir(t *testing.T) string {
	...
	// We don't use os.UserCacheDir() because the paths it
	// returns are different on different operating systems.
	// This makes it harder to specify which cache dir to use
	// in Github Actions.
