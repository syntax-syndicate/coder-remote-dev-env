...
| `app_id`               | string                                                               | false    |              |                                                                                                                                               |
| `created_at`           | string                                                               | false    |              |                                                                                                                                               |
| `icon`                 | string                                                               | false    |              | Icon is an external URL to an icon that will be rendered in the UI. Deprecated: This field is unused and will be removed in a future version. |
| `id`                   | string                                                               | false    |              |                                                                                                                                               |
| `message`              | string                                                               | false    |              |                                                                                                                                               |
